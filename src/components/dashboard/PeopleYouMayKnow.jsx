            ...
            >
              ...
              <div className="w-full pt-0.5">
                {status === 'pending' ? (
                  <button
                    disabled
                    className="w-full text-[10px] sm:text-xs font-semibold text-amber-500 border border-amber-500/30 bg-amber-500/10 py-1.5 sm:py-2 rounded-lg sm:rounded-xl flex items-center justify-center gap-1 cursor-not-allowed"
                  >
                    <Clock className="w-3 h-3 sm:w-3.5 sm:h-3.5" /> Sent
                  </button>
                ) : status === 'accepted' ? (
                  <button
                    disabled
                          ...
                          <div className="flex items-center gap-2 pt-1">
                            <div className="flex-1">
                              {status === 'pending' ? (
                                <button
                                  disabled
                                  className="w-full text-xs font-semibold text-amber-500 border border-amber-500/30 bg-amber-500/10 py-2 rounded-xl flex items-center justify-center gap-1 cursor-not-allowed"
                                >
