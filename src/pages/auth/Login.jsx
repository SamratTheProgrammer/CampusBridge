            ...
            {authSettings.enableGoogleAuth && (
              <div className="mt-6">
                ...
                <button 
                  ...
                  type="button"
                  className="w-full mt-6 py-2.5 flex items-center justify-center gap-2 border border-input rounded-lg hover:bg-muted transition-colors font-medium text-foreground disabled:opacity-50"
                >
