...
import { Users, BookOpen, Clock, Activity, TrendingUp, TrendingDown, MoreVertical, GraduationCap, UserCheck, Briefcase, Calendar, HelpingHand, MessageSquare } from 'lucide-react'
...
const AdminDashboard = () => {
  ...
  const totalUsersCount = (data.stats.totalStudents || 0) + (data.stats.totalMentors || 0) + (data.stats.totalAlumni || 0)
  ...
  return (
    <div className="space-y-8">
      ...
      {isLoading ? (
        <AdminSpinner message="Loading live analytics and dashboard metrics..." />
      ) : (
        <>
          {/* Grid Stats */}
